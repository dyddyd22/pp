...
let boxOver = document.querySelectorAll(".measure .model-box,.map-item");
...
// 창업지원사업 탭
let planItem = document.querySelectorAll(
    ".plan-item,.order-box .btn-order,.pop-item"
);
let planInfos = document.querySelectorAll(
    ".plan-infos,.order-wrap .order-inner, .pop-item-box"
);
